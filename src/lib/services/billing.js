...
export const BillingService = {
      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: {
              name: `AI Knowledge Base - ${plan.name}`,
              description: `Purchase ${plan.credits} credits to train custom knowledge agents and playground query bots.`,
            },
  ...
  async handleWebhook(body, signature) {
    ...
    try {
      ...
      throw new Error(`Webhook Signature Verification Error: ${err.message}`);
    }
